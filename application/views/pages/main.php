<div class="d-flex bd-highlight">
    <div class="p-2 ml-auto mr-5 w-50 h-50 bd-highlight">
    ...
    <div class="p-2 mr-auto flex-shrink-1 bd-highlight border border-danger">
        <form action="<?php echo site_url('beastup/login'); ?>" method="post">
